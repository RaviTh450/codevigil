...
object ReportGenerator {
    ...
    fun generateHtml(data: ReportData): String {
        return buildString {
            ...
            appendLine("<title>Code Pattern Analysis Report - ${escapeHtml(data.patternName)}</title>")
            appendLine("<style>")
            ...
            appendLine("<h1>Code Pattern Analysis Report</h1>")
            ...
            appendLine("<p>Generated by <strong>Code Pattern Analyzer</strong></p>")
            appendLine("</div>")
    ...
    fun generateSarif(data: ReportData): String {
        ...
        sb.appendLine("""        "name": "Code Pattern Analyzer",""")
        sb.appendLine("""        "informationUri": "https://github.com/codepattern/code-pattern-analyzer",""")
